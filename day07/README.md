...
Those beams continue downward until they reach more splitters. This process continues until all of the tachyon beams reach a splitter or exit the manifold.

**Key detail:** Multiple beams can merge into the same column - they count as one beam at that position (like the middle beam between adjacent splitters).
